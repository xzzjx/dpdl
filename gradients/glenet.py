...
def inference(images):
    ...
    #     zeros = tf.zeros_like(fc3, dtype=fc3.dtype)
    #     cond = (fc3 >= zeros)
    #     relu_logits = tf.where(cond, fc3, zeros)
...
def loss_fun2(logits, y, graph):
    '''
    logits is log likelihood
    y is one-hot vector
    '''
    return noisy_loss.compute_loss(logits, y, graph, name='computeloss')